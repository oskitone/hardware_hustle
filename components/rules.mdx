...
Fill out the "{ID_TITLE}" line in the game sheet's top left, then familiarize yourself with the rest of its layout: Phases table, Money/Turn graph, and six turn spreadsheets.

![Hardware Hustle game sheet layout](../screenshot.png)

The player with the second highest die roll goes first, then proceed clockwise.
...
You begin each turn taking stock of what you have and what you need.
...
The <Opportunity /> costs are a table of values, but, for all the phases of your first turn, you'll only use the ones in the first column with the dark outline. To buy a <A />, you need <OpportunityX value={0} /> and <MoneyX value={1} />; to buy a <B /> you need <OpportunityX value={1} /> and <MoneyX value={2} />; etc. You'll revisit <Opportunity /> costs in the PM phase.
...
You can make as much or as little as you want, provided you have the required parts and <Opportunity />. In later turns, you can use parts purchased in previous turns.
...
1. **Resolve <Opportunity />:**
   ...
   - Otherwise, **Roll for research**. Its value is the <Opportunity /> cost it would take to upgrade _one_ of the previous three phases' actions.
...
{/* TODO: ensure no orphan <p> */}

Cross out the entire next turn's spreadsheet. You cannot do any of its phases.

#### Research Upgrade

Did you roll less than or equal to your remaining <Opportunity />? Your research succeeded. Circle the PM column's <Opportunity /> cell to mark its success; otherwise cross it out for failure:
...
Recall how you've only been using the first column of <Opportunity /> values with the dark outline. If your research upgrade was successful, choose _one_ phase action (Buy, Make, or Sell) to spend it on, then shade in its column and outline the next values to its right.
...
* The <Opportunity /> roll for research is used differently than it is for Buy/Make/Sell. For those, it's a maximum that you want to roll high; for research, you want to roll low.
...
* When an item uses <OpportunityX value={0} /> to Buy/Make/Sell, it's effectively "free" for the rest of the game.
