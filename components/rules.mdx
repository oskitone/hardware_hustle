...
Note that the <Opportunity /> roll for research is used differently than Buy/Make/Sell. For the other actions, it's a maximum that you want to roll high; for research, you want to roll low.
...
If you burnout in the last turn, you automatically lose. In the case of a tie, the player who lost the fewest turns to burnout wins.
