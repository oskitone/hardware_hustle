...
You have six turns to buy parts to make widgets, make widgets from parts, and sell widgets for money. Each action takes Opportunity, which you have less and less of as the game progresses. At the end of each turn, you can spend excess Opportunity to attempt a research upgrade, making you better at buying, making, or selling.
...
{/* <table>
  <thead>
    <tr><th /><th>Part</th><th><Opportunity /></th><th><Money /></th></tr>
  </thead>
  <tbody>
    <tr><th><A /></th><td>Fastener</td><td>0</td><td>1</td></tr>
    <tr><th><B /></th><td>Enclosure</td><td>1</td><td>2</td></tr>
    <tr><th><C /></th><td>Controls</td><td>2</td><td>3</td></tr>
    <tr><th><D /></th><td>Integrated Circuit</td><td>3</td><td>4</td></tr>
  </tbody>
</table> */}
...
Time to wrap the day up.

The cells in the PM column are all prefixed with **=**. In this phase, you finish the math to complete the spreadsheet, ending the turn.
...
Remember how you've only been using the first column of <Opportunity /> values with the dark outline? If your research succeeded, choose _one_ action to spend it on, then cross its column out and outline the values to their right.
...
The values in your PM column carry over to the empty cells in the next turn's AM column, as denoted by their "**⇢**" prefix.
