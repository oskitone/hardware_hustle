...
You begin each turn by taking stock of what you have and what you need.
...
- You can buy as many or as few as you want and even multiples of the same part, as long as you have the required <Opportunity /> and <Money />. (The sum <Opportunity /> must be less than or equal to your roll, and the sum <Money /> must be less than or equal to what you have in the AM column.)
...
For skipped turns, fill the "**⇢**" cells on the next playable turn from the previously played turn.
