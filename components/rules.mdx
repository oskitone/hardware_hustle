...
As for <Opportunity />, if you exhaust yourself and go negative, you **Burnout** and lose the entire next turn! In this example, you have <Icon id="opportunity" />3 so are safe.
