...
(Later turns will have empty cells to fill out, but there still won't be any decision-making or die-rolling. For that reason, AM is not listed in the Phases table on the left of your game sheet.)
