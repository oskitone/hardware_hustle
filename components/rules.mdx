...
<dl>
  <div><dd><A /></dd><dt>Gear</dt></div>
  <div><dd><B /></dd><dt>Enclosure</dt></div>
...
<dl>
  <div><dd><AB /></dd><dt>Amp</dt></div>
  <div><dd><ABC /></dd><dt>Boombox</dt></div>
  <div><dd><ABCD /></dd><dt>Game</dt></div>
</dl>
...
Icons are Bootstrap and Ionicons, both MIT licensed.
