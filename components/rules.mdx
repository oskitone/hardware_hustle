...
1. **Resolve <Opportunity />:**
   ...
   - Otherwise, **roll for research upgrade**. Its value is the <Opportunity /> cost it would take to upgrade _one_ of the previous three phases' actions. See below for more info.
