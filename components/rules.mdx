...
For one or more people. Ages 10 and up. Takes about 20 minutes to play.
...
Fill out the "{ID_TITLE}" line in the game sheet's top left, then familiarize yourself with the game sheet: Phases table, Money/Turn graph, and six turn spreadsheets.
...
Its columns are phases that you fill out from left to right during your turn.
...
You start each turn taking stock of what you have and what you need.

For the game's first turn, there's nothing to do here besides note the starting pre-filled values: <MoneyX value={10}/>, <OpportunityX value={12}/>, and 0 everything else.
...
1. **Roll:**
    ...
    * Based on how much <Money /> you have in the AM column and the max <Opportunity /> you just rolled, decide which parts to buy.
...
- You can also choose to buy nothing and skip this Phase, although that is a gutsy move on your first turn!
...
Next, you'll use the parts you've bought to make widgets. The Phases table lists what you can make, their <Opportunity /> costs, and the parts that they'll use:

<ActionsTable actions={[ACTIONS.MAKE]} className={styles.ActionsTable} />

Again, for now, only use the outlined <Opportunity /> values for now.

To complete the Make phase:

1. **Roll:**
    * Roll a die. Its value is the _maximum_ <Opportunity /> you can spend making this turn.
    * Based on which parts you have available and the max <Opportunity /> you just rolled, decide which widgets to make.
...
Just like in the Buy phase, you can make as much or as little as you want, provided you have the required parts and <Opportunity />. In later turns, you can use parts purchased in previous turns.
...
1. **Roll:**
    ...
    * Based on which widgets you have available and the max <Opportunity /> you just rolled, decide which widgets to sell.
...
Sell as much or as little as you want, provided you have the required widgets and <Opportunity />. In later turns, you can sell widgets made in previous turns.

### 5. PM

It's time to wrap up your workday and end the turn.
...
You've spent more <Opportunity /> than you had available and have to spend the whole next day recuperating.

Cross out the entire next turn's spreadsheet. You cannot do any of its phases.

#### Research Upgrade

Did you roll less than or equal to your remaining <Opportunity />? Your research succeeded. Circle the cell to mark its success; otherwise cross it out for failure:
...
Recall how you've only been using the first column of <Opportunity /> values with the dark outline. If your research upgrade was successful, choose _one_ phase action to spend it on, then cross its column out and outline the values to their right.

As an example, here's what the Phases table would look like after a successful research upgrade to Make:
...
The player with the most money at the end. Unused parts and unsold widgets count for nothing, only money. In the case of a tie, the player with the fewest burnouts wins.
