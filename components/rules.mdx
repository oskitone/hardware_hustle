...
The <Opportunity /> costs are a table of values, but, for all the phases of your first turn, you'll only use the ones in the leftmost column with the dark outline. To buy a <A />, you need <OpportunityX value={0} /> and <MoneyX value={1} />; to buy a <B /> you need <OpportunityX value={1} /> and <MoneyX value={2} />; etc. You'll revisit <Opportunity /> costs in the PM phase a little later.
...
1. **Plot:** Mark a dot on the "Money/Turn" graph at your new <Money /> total, then draw a line connecting it to the previous dot.
