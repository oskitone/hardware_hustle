...
For 1+ players. Ages 10+. ~20min/play.
...
Fill out the "{ID_TITLE}" line in the top left of the game page, then familiarize yourself with the rest of its layout: Phases table, Money/Turn graph, and six turn spreadsheets.
...
1. ### AM
   Take stock of what you have/need
1. ### Buy
...
1. **Tally:** Finish each row's equation into the final column prefixed with **=**.
...
The Phases table summarises PM's <Opportunity /> resolution:
