...
Our <Opportunity /> roll wasn't enough to sell both of the Widgets we made, so we could only move the <AB />. See how that works? You can Buy/Sell/Make as much as you want but only within what you roll/have.
